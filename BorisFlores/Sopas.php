...
<div id="contenedor-preloader">
    ...
    <nav id="nv-s" class="navbar navbar-expand-lg navbar-dark" style="background: rgba(28, 35, 49,0.9);">
        ...
        <div class="contenedor-grid">
            ...
            <div class="grid-item">
                <div class="contenedor-img">
                    <img src="Imagenes/ImgDelivery/<?php echo $fila['imagen'];?>" alt="">        
                </div>      
      ...
      <label for="" class="icon-basket">asdasd</label>
      <footer class="contenedor-footer fixed-bottom mt-3">    
