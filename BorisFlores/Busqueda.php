    ...
    <nav id="nv-s" class="navbar navbar-expand-lg navbar-dark" style="background: rgba(28, 35, 49,0.9);">
      ...
      <main>
        <div class="contenedor-titulo">
            <h1>Busqueda de Antojos</h1>       
            <h2>Hoy se te antoja <?php echo "'".$_GET['buscar']."'"?></h2>     
        </div>        
        <div class="contenedor-grid">
            ...
            <div class="grid-item">
                <div class="contenedor-img">
                    <img src="Imagenes/ImgDelivery/<?php echo $fila['imagen']?>" alt="<?php echo $fila['nombre']?>">        
                </div>      
            ...
            <?php } } else{
              echo "<h2 style='color:#666;width:100%'>No hay resultados </h2>";
            }
              ?>            
        </div>
      </main>      
